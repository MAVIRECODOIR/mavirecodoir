...
const NAV_DATA: NavItem[] = [
  ...
  },
  {
    ...
    href: "/archive",
    children: [
      { label: "View All", href: "/archive" },
    ],
  },
  {
    label: "World of MAVIRE",
    href: "/about",
    children: [
    ...
    <>
      ...
      <nav
        ...
        style={{
          ...
          transition:
            "opacity 0.36s cubic-bezier(0.31, 0, 0.13, 1) 0.1s, transform 0.5s cubic-bezier(0.31, 0, 0.13, 1)",
        ...
        className="max-md:!left-0 max-md:!right-0 max-md:!top-0 max-md:!bottom-0 max-md:!w-full max-md:!rounded-none"
      >
        ...
        <div style={{ margin: "0 24px" }}>
          <div
            style={{
              ...
              height: headerHeight,
              padding: isMobile ? "28px 0" : "24px 0",
            }}
          >
        ...
        {/* ─── Divider ─── */}
        <div style={{ height: 1, background: "rgb(229, 229, 229)", margin: "0" }} />
        ...
        <div
          style={{
            flex: "1 1 0%",
            overflowY: "auto",
            padding: isMobile ? "16px 0 56px" : "12px 0 48px",
          }}
        >
            ...
            {NAV_DATA.map((item, i) => (
              <li
                ...
                style={{
                  display: "flex",
                  flexDirection: "column",
                  transition: "color 0.25s cubic-bezier(0.31, 0, 0.13, 1)",
                  color: "rgb(51, 56, 60)",
                }}
              >
                {item.children ? (
                  <button
                    ...
                    style={{
                      ...
                      transition: `transform 0.7s cubic-bezier(0.31, 0, 0.13, 1) ${0.16 + i * 0.016}s, opacity 0.7s cubic-bezier(0.31, 0, 0.13, 1) ${0.16 + i * 0.016}s`,
                    }}
                  >
                    <span style={{ paddingBottom: 4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {item.label}
                    </span>
                    <ChevronIcon
                      size={chevronSize}
                  ...
                  <Link
                    ...
                    style={{
                      ...
                      padding: l1Padding,
                      margin: 0,
                      color: item.href === "#" ? "rgb(123, 132, 135)" : "rgb(51, 56, 60)",
                      font: `400 ${l1FontSize}px/${l1LineHeight}px inherit`,
                      textDecoration: "none",
                      position: "relative",
                      opacity: visible ? 1 : 0,
                  ...
                  >
                    <span style={{ paddingBottom: 4 }}>
                      {item.label}
                      {item.href === "#" && (
                        <span style={{ marginLeft: 8, fontSize: l2FontSize, fontWeight: 500, color: "rgb(123, 132, 135)" }}>
                          — Coming Soon
                        </span>
                      )}
                    </span>
                ...
                {item.children && (
                  <div
                    style={{
                      overflow: "hidden",
                      maxHeight: activeL1 === i ? `${item.children.length * (isMobile ? 52 : 40) + 16}px` : "0",
                      opacity: activeL1 === i ? 1 : 0,
                      transition: "max-height 0.5s cubic-bezier(0.31, 0, 0.13, 1), opacity 0.4s cubic-bezier(0.31, 0, 0.13, 1)",
                    }}
                  >
                        ...
                        <li key={child.label}>
                          <Link
                            ...
                            style={{
                              ...
                              textDecoration: "none",
                              opacity: activeL1 === i ? 1 : 0,
                              transform: activeL1 === i ? "translateX(0)" : "translateX(-10px)",
                              transition: `transform 0.5s cubic-bezier(0.31, 0, 0.13, 1) ${ci * 0.03}s, opacity 0.5s cubic-bezier(0.31, 0, 0.13, 1) ${ci * 0.03}s`,
                            }}
                          >
          ...
          {/* ─── Divider ─── */}
          <div style={{ height: 1, background: "rgb(229, 229, 229)", margin: "12px 24px 0" }} />
            ...
            {BOTTOM_LINKS.map((link, i) => (
              <Link
                ...
                style={{
                  ...
                  opacity: visible ? 1 : 0,
                  transform: visible ? "translateX(0)" : "translateX(-10px)",
                  transition: `transform 0.7s cubic-bezier(0.31, 0, 0.13, 1) ${0.3 + i * 0.02}s, opacity 0.7s cubic-bezier(0.31, 0, 0.13, 1) ${0.3 + i * 0.02}s`,
                }}
              >
                {link.icon === "bag" && (
                  <svg width={botIconSize} height={botIconSize} viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path d="M18 7h-2.25V5.75C15.75 4.79 14.97 4 14 4H10c-.96 0-1.75.78-1.75 1.75V7H6c-1.1 0-2 .89-2 2v9c0 1.1.89 2 2 2h12c1.1 0 2-.89 2-2V9c0-1.1-.89-2-2-2Zm-8.25-1.25c0-.14.11-.25.25-.25h4.01c.14 0 .25.11.25.25V7H9.76V5.75ZM18.5 18.01c0 .27-.22.5-.5.5H6c-.27 0-.5-.22-.5-.5V9.01c0-.27.22-.5.5-.5h2.25v1.5h1.5v-1.5h4.5v1.5h1.5v-1.5H18c.27 0 .5.22.5.5v9Z" fill="rgb(51, 56, 60)" />
                  </svg>
                )}
                {link.icon === "wishlist" && (
                  <svg width={botIconSize} height={botIconSize} viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path fillRule="evenodd" d="M13.641 5.627a4.44 4.44 0 0 1 3.348 0 4.4 4.4 0 0 1 1.422.935c.408.4.732.877.953 1.402a4.27 4.27 0 0 1 0 3.315 4.3 4.3 0 0 1-.953 1.402l-5.92 5.818a.7.7 0 0 1-.982 0l-5.92-5.818A4.3 4.3 0 0 1 4.3 9.62c0-1.15.465-2.25 1.289-3.06a4.42 4.42 0 0 1 3.096-1.26c1.159 0 2.272.452 3.096 1.26l.219.216.22-.215a4.4 4.4 0 0 1 1.421-.935M15.315 6.7a3 3 0 0 0-1.146.224 3 3 0 0 0-.968.636l-.71.698a.7.7 0 0 1-.982 0l-.71-.698a3.02 3.02 0 0 0-2.114-.86c-.796 0-1.556.311-2.115.86a2.9 2.9 0 0 0-.87 2.061c0 .771.311 1.513.87 2.061L12 17.02l5.43-5.337a2.9 2.9 0 0 0 .645-.947 2.87 2.87 0 0 0-.645-3.175 3 3 0 0 0-.969-.636 3 3 0 0 0-1.146-.224" fill="rgb(51, 56, 60)" clipRule="evenodd" />
                  </svg>
                )}
                {link.icon === "account" && (
                  <svg width={botIconSize} height={botIconSize} viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path d="M12 14c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5Zm0-8.5c1.93 0 3.5 1.57 3.5 3.5S13.93 12.5 12 12.5 8.5 10.93 8.5 9 10.07 5.5 12 5.5ZM18.75 18v2h-1.5v-2c0-.69-.56-1.25-1.25-1.25H8c-.69 0-1.25.56-1.25 1.25v2h-1.5v-2c0-1.52 1.23-2.75 2.75-2.75h8c1.52 0 2.75 1.23 2.75 2.75Z" fill="rgb(51, 56, 60)" />
                  </svg>
                )}
                {link.icon === "search" && (
                  <svg width={botIconSize} height={botIconSize} viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <path d="M20 12c0-4.42-3.58-8-8-8s-8 3.58-8 8 3.58 8 8 8c1.94 0 3.72-.69 5.1-1.84L18.94 20 20 18.94l-1.84-1.84C19.31 15.72 20 13.94 20 12Zm-8 6.5c-3.58 0-6.5-2.92-6.5-6.5S8.42 5.5 12 5.5s6.5 2.92 6.5 6.5-2.92 6.5-6.5 6.5Z" fill="rgb(51, 56, 60)" />
                  </svg>
                )}
            ...
            {isLoggedIn && (
              <button
                ...
                style={{
                  ...
                  opacity: visible ? 1 : 0,
                  transform: visible ? "translateX(0)" : "translateX(-10px)",
                  transition: `transform 0.7s cubic-bezier(0.31, 0, 0.13, 1) 0.44s, opacity 0.7s cubic-bezier(0.31, 0, 0.13, 1) 0.44s`,
                }}
              >
                <svg width={botIconSize} height={botIconSize} viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2Zm-7 3.3c1.93 0 3.5 1.57 3.5 3.5S13.93 13.3 12 13.3 8.5 11.73 8.5 9.8 10.07 6.3 12 6.3ZM12 18c-2.03 0-4.43-.82-5.14-1.26a.47.47 0 0 1-.13-.71c.69-.98 2.76-1.53 5.27-1.53s4.58.55 5.27 1.53c.15.21.12.5-.13.71C16.43 17.18 14.03 18 12 18Z" fill="rgb(51, 56, 60)" />
                </svg>

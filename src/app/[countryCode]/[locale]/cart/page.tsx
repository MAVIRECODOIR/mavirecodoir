                ...
                <div className="flex justify-center mb-40 md:mb-24">
                  <div className="w-full max-w-[450px]">
                    ...
                    <button
                      type="button"
                      onClick={handleCheckout}
                      className="w-full mt-3 h-12 border border-[#33383C] text-[#33383C] text-[13px] md:text-[14px] font-medium hover:bg-[#33383C] hover:text-white transition-colors flex items-center justify-center md:rounded-md"
                    >
                      Pay with PayPal
                    </button>
                  </div>

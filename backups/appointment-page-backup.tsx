    ...
    <div className="pt-32 pb-24">
      <section className="text-center mb-20">
        <RevealBlock>
          ...
          <p className="luxury-body max-w-lg mx-auto opacity-70">
      ...
      <section className="luxury-container mb-24">
        <RevealBlock>
          <h2 className="luxury-caption text-black/40 text-center mb-10">Our Boutiques</h2>
        </RevealBlock>
          ...
          {BOUTIQUES.map((b, i) => (
            <RevealBlock key={b.name} delay={i * 150}>
              <div className="p-8 bg-brand-cream/30 text-center">
                ...
                <p className="text-xs tracking-wider text-black/50 mb-1">{b.address}</p>
                <p className="text-xs tracking-wider text-black/40">{b.hours}</p>
              </div>
            </RevealBlock>
          ))}
        </div>
        ...
        <RevealBlock delay={200}>
          <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className="luxury-caption block mb-2 text-black/50">Full Name</label>
              ...
              <div>
                <label className="luxury-caption block mb-2 text-black/50">Email</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className="luxury-caption block mb-2 text-black/50">Phone</label>
              ...
              <div>
                <label className="luxury-caption block mb-2 text-black/50">Boutique</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className="luxury-caption block mb-2 text-black/50">Preferred Date</label>
              ...
              <div>
                <label className="luxury-caption block mb-2 text-black/50">Preferred Time</label>
            ...
            <div>
              <label className="luxury-caption block mb-2 text-black/50">Service</label>

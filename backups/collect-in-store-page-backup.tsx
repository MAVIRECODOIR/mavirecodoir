          ...
          {STEPS.map((step, i) => (
            <RevealBlock key={step.num} delay={i * 200}>
              <div className="text-center">
                <span className="block text-5xl font-extralight tracking-tighter text-black/10 mb-4">{step.num}</span>
                <h3 className="luxury-caption mb-4">{step.title}</h3>
                <p className="luxury-body text-black/60 leading-relaxed">{step.desc}</p>
              </div>
            </RevealBlock>
          ))}
        </div>
            ...
            {[
              ...
              <RevealBlock key={b.title} delay={i * 120}>
                <div className="text-left">
                  ...
                  <p className="luxury-body text-black/55 leading-relaxed">{b.desc}</p>
                </div>
              </RevealBlock>
            ))}
          </div>
